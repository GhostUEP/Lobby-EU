...
public class ScoreboardAPI {
	...
	public static void setScoreBoard(Player p) {
		ScoreboardAPI score = new ScoreboardAPI(ChatColor.DARK_RED + "EMITOWS" + ChatColor.GRAY + "." + ChatColor.RED + "COM");
		score.add(ChatColor.GRAY + "Players Online: " + ChatColor.YELLOW + Main.plugin.globalcouting);
		score.build();
		score.send(p);
